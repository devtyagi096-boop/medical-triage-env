...
- **Manage limited resources** such as treatment beds and medical staff
- **Minimize patient harm** and waiting times
- **Handle varying patient volumes** and acuity levels across different tasks
...
- ✅ **Simulates real constraints** — Bed availability, staff limitations, and patient arrivals
